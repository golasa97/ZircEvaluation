...
python3 scripts/calculate_xs_from_ladder.py ${zr90_sampledir} ${zr90_xs0Kdir} --mass ${zr90_mass} --radius ${zr90_radius} --spin ${zr90_spin} --emin 1e5 --emax 5e5 --global_points 5000 --local_points 100 --width_multiplier 10.0
python3 scripts/calculate_xs_from_ladder.py ${zr91_sampledir} ${zr91_xs0Kdir} --mass ${zr91_mass} --radius ${zr91_radius} --spin ${zr91_spin} --emin 1e5 --emax 5e5 --global_points 5000 --local_points 100 --width_multiplier 10.0
python3 scripts/calculate_xs_from_ladder.py ${zr92_sampledir} ${zr92_xs0Kdir} --mass ${zr92_mass} --radius ${zr92_radius} --spin ${zr92_spin} --emin 1e5 --emax 5e5 --global_points 5000 --local_points 100 --width_multiplier 10.0
python3 scripts/calculate_xs_from_ladder.py ${zr94_sampledir} ${zr94_xs0Kdir} --mass ${zr94_mass} --radius ${zr94_radius} --spin ${zr94_spin} --emin 1e5 --emax 5e5 --global_points 5000 --local_points 100 --width_multiplier 10.0
#
